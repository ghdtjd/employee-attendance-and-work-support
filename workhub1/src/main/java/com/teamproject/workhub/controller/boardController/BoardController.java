...
public class BoardController {
    ...
    public ResponseEntity<List<BoardResponseDTO>> getImportanceTopFive() {
        List<BoardResponseDTO> fiveBoards = boardService.getImportanceTopFive();
        return ResponseEntity.ok(fiveBoards);
    }
